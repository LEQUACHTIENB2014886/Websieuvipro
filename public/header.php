		...
		<div class="container">
			<div class="row">
				...
				<div class="col justify-content-center text-dark font-weight-bold">
					<a href="#" title="Trang Chủ" class="dlinh">Trang Chủ</a>
				</div>
						...
						<div class="signin">
							...
							<form action="#" method="post" class="login-form">
								...
								<div class="form-group1">
									<br>
									<div class="input-group">
										<button type="submit" name="btn_login" value="Dang nhap">Đăng Nhập</button>
									</div>
									<br>
								</div>
							</form>
						...
						<div class="signup">
							...
							<form action="#" method="post" class="registration-form">
								...
								<div class="form-group">
									<br>
									<div class="input-group">
										<button type="submit" name="btn_register" value="Dang ky">Đăng Ký</button>
									</div>
									<br>
								</div>
							</form>
